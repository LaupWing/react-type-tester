...
const rootReducer = (state = initState, action)=>{
    ...
    if(action.type === 'SET_INPUTDISPLAY'){
        return{
            ...state,
            inputDisplay: action.inputDisplay
        }
    }
    return state
}
